...
public final class CallTracer implements Closeable {
    ...
    private static Boolean useArgumentss = false;
    private static Boolean useResultss = false;
    private static Boolean useSpecificSourceLocationss = false;
    private static Boolean useTexts = false;
    private static Boolean useTimes = false;
    //Javascript only
    private static Boolean useObjectInstancess = false;
            ...
            if ((System.nanoTime() - initialTime) > warmup) {
                ...
                Truffle.getRuntime().iterateFrames(frame2 -> {
                    ...
                    if (node != null) {
                        ...
                        if (useObjectInstancess){
                            if (frame.getArguments() != null) {
                                newKey.objectInstanceKey = frame.getArguments()[0];
                            }
                        }
                        if (useSpecificSourceLocationss){
