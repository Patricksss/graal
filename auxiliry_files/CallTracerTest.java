...
public class CallTracerTest extends AbstractProfilerTest {
    ...
    public void testRecursiveArguments() {
        ...
        expectedCountMap.put("main,calc,\"class com.oracle.truffle.api.strings.TruffleString\",\"class java.lang.Integer\"", 1L);
        expectedCountMap.put("calc,sum,\"class com.oracle.truffle.api.strings.TruffleString\"", 60L);
        expectedCountMap.put("calc,sum,\"class java.lang.Integer\"", 60L);
        expectedCountMap.put("calc,calc,\"class java.lang.Integer\"", 5L);
        expectedCountMap.put("calc,calc,\"class com.oracle.truffle.api.strings.TruffleString\"", 5L);
        expectedCountMap.put(":program,main", 1L);
    ...
    public void testCorrectCallCount() {
        ...
        expectedCountMap.put("output,output", 2L);
    ...
    public void testCorrectArgumentCount() {
        ...
        expectedCountMap.put("main,calc,\"class com.oracle.truffle.api.strings.TruffleString\"", 1L);
        expectedCountMap.put("calc,sum,\"class com.oracle.truffle.api.strings.TruffleString\"", 10L);
    ...
    public void testCorrectResultCount() {
        ...
        expectedCountMap.put("output,output,class com.oracle.truffle.js.runtime.objects.Nullish", 2L);
    ...
    public void testCorrectLocationCount() {
        ...
        expectedCountMap.put("output,output,17", 2L);
    ...
    public void testCorrectObjectInstanceCount() {
        ...
        //Minus 1 is nescesarry since :program is also called
        Assert.assertEquals(
                "Total number of counters does not match after one excecution",
                expectedCountMap.size(), callMapCount.size()-1);
    }
    ...
    private void executeAndCheckRootNameCounters(Source recursiveSource,
        ...
        for (Map.Entry<Integer, Integer> entry : callMapCount.entrySet()) {
            ...
            if(callMapKey.get(mapKey).sourceSourceSection != null) {
                String sourceKey = callMapKey.get(mapKey).sourceRootNode.toString().replace(",", ";");
                String targetKey = callMapKey.get(mapKey).targetRootNode.toString().replace(",", ";");
